package com.example.myintentapp020;
    ...
    public void onClick(View v){
        switch (v.getId()) {
            ...
            case R.id.btn_move_activity_data:
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Gema Annisa");
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_AGE, 20);
                startActivity(moveWithDataIntent);
                break;
            case R.id.btn_dial_number:
                String phoneNumber = "089631593011";
                Uri number = Uri.parse("tel:089631593011");
                Intent dialPhoneIntent = new Intent(Intent.ACTION_DIAL, number);
                startActivity(dialPhoneIntent);
                break;
            case R.id.btn_move_activity_object:
                Person mPerson = new Person();
                mPerson.setName("Gema Annisa Hermastuti");
                mPerson.setAge(20);
                mPerson.setEmail("gema.annisa1020@students.unila.ac.id");
                mPerson.setCity("Banda Lampung");
